...
function listDivFun(){
    for(let data of products.data){
        ...
        let newIDiv = document.createElement("div");
        newIDiv.className = 'iTag'
        newIDiv.innerHTML = `
...
function addProducts(){
    ...
    const notFoundBox = document.querySelector(".notFund-area");
    let hide = document.querySelectorAll(".shop-products-box .hide");
    let list = document.querySelectorAll(".shop-products-box .list")
    ...
    element.addEventListener("click", ()=> {
        ...
        for(let i = 0; i < productsBtn.length; i++){
            ...
            if(mainProduct.children[0].src == minusProduct){
                let element = mainProduct.children[5];
